...
('Luca', 'Meier', '2006-02-14', 'Bahnhofstrasse 5, 8001 Zürich', 'luca.meier@example.ch', '0791112222', '2023-03-01', 'aktiv'),
...
(33, 'Jahresabo', '2024-06-01', '2025-05-31', 599.00, 'aktiv');
...
('Yoga Flow', 'Mobilität und Balance', 'Montag', '18:00:00', 60, 'Studio 1', 'S. Frank', 20),
('HIIT', 'Intervalltraining', 'Mittwoch', '19:00:00', 45, 'Studio 2', 'L. Frei', 18),
('Spinning', 'Cardio auf dem Bike', 'Freitag', '17:30:00', 50, 'Cycling Room', 'S. Baumann', 16),
...
(1, 'Ganzkörper – Einsteiger', '2024-09-05', '2024-09-05'),
(2, 'Ganzkörper – Einsteiger', '2024-09-10', '2024-09-10'),
(3, 'Ganzkörper – Einsteiger', '2024-09-12', '2024-09-12'),
(4, 'Ganzkörper – Einsteiger', '2024-10-01', '2024-10-01'),

(5, 'Muskelaufbau – Oberkörper', '2024-09-15', '2024-09-15'),
(6, 'Muskelaufbau – Oberkörper', '2024-10-05', '2024-10-05'),
(7, 'Muskelaufbau – Oberkörper', '2024-11-01', '2024-11-01'),
(8, 'Muskelaufbau – Oberkörper', '2024-11-10', '2024-11-10'),

(9, 'Muskelaufbau – Unterkörper', '2024-10-20', '2024-10-20'),
(10, 'Muskelaufbau – Unterkörper', '2024-11-05', '2024-11-05'),
(11, 'Muskelaufbau – Unterkörper', '2024-11-15', '2024-11-15'),

(12, 'Cardio & Ausdauer', '2024-09-01', '2024-09-01'),
(13, 'Cardio & Ausdauer', '2024-09-20', '2024-09-20'),
(14, 'Cardio & Ausdauer', '2024-10-10', '2024-10-10'),
(15, 'Cardio & Ausdauer', '2024-11-01', '2024-11-01'),

(16, 'Functional Training', '2024-10-15', '2024-10-15'),
(17, 'Functional Training', '2024-11-10', '2024-11-10'),
(18, 'Functional Training', '2024-12-01', '2024-12-01'),

(19, 'Reha & Mobilität', '2024-10-05', '2024-10-05'),
(20, 'Reha & Mobilität', '2024-11-01', '2024-11-01'),

(21, 'HIIT Programm', '2024-10-25', '2024-10-25'),
(22, 'HIIT Programm', '2024-11-20', '2024-11-20'),
(23, 'HIIT Programm', '2024-12-10', '2024-12-10'),

(24, 'Ganzkörper – Intensiv', '2024-11-05', '2024-11-05'),
(25, 'Ganzkörper – Intensiv', '2024-11-15', '2024-11-15'),

(26, 'Core & Balance', '2024-10-12', '2024-10-12'),
(27, 'Core & Balance', '2024-11-12', '2024-11-12'),

(28, 'Einsteiger Fitness', '2024-09-08', '2024-09-08'),
(29, 'Einsteiger Fitness', '2024-09-18', '2024-09-18'),
(30, 'Einsteiger Fitness', '2024-10-02', '2024-10-02'),
(31, 'Einsteiger Fitness', '2024-10-18', '2024-10-18'),
(32, 'Einsteiger Fitness', '2024-11-02', '2024-11-02'),
(33, 'Einsteiger Fitness', '2024-11-18', '2024-11-18');
...
(1, 'Kniebeuge', 3, 12, 20),
(1, 'Liegestütze', 3, 10, 0),
(2, 'Kniebeuge', 3, 12, 22.5),
(2, 'Liegestütze', 3, 10, 0),
(3, 'Kniebeuge', 3, 15, 20),
(3, 'Plank', 3, 1, 0),
(4, 'Kniebeuge', 3, 12, 25),
(4, 'Plank', 3, 1, 0),
...
(6, 'Bankdrücken', 4, 8, 45),
(6, 'Latziehen', 3, 10, 40),
(7, 'Bankdrücken', 4, 6, 50),
(7, 'Latziehen', 3, 8, 45),
(8, 'Schulterdrücken', 3, 10, 30),

-- Unterkörper
(9, 'Beinpresse', 3, 12, 80),
(10, 'Beinpresse', 3, 10, 90),
(11, 'Kreuzheben', 4, 6, 60),

-- Cardio
(12, 'Laufband', 1, 1, 0),
(13, 'Crosstrainer', 1, 1, 0),
(14, 'Laufband', 1, 1, 0),
(15, 'Crosstrainer', 1, 1, 0),

-- Functional / HIIT
(16, 'Burpees', 3, 15, 0),
(17, 'Kettlebell Swing', 3, 20, 16),
(18, 'Burpees', 3, 20, 0),
(21, 'Jump Squats', 3, 20, 0),
(22, 'Mountain Climbers', 3, 30, 0),
(23, 'Jump Squats', 3, 25, 0),

-- Core / Reha
(19, 'Plank', 3, 1, 0),
(20, 'Mobilisation Hüfte', 1, 1, 0),
(26, 'Russian Twists', 3, 20, 0),
(27, 'Crunches', 3, 25, 0),

-- Intensiv
(24, 'Kniebeuge', 4, 10, 40),
(25, 'Kreuzheben', 4, 6, 80),

-- Einsteiger
(28, 'Liegestütze', 3, 8, 0),
(29, 'Liegestütze', 3, 10, 0),
(30, 'Plank', 3, 1, 0),
(31, 'Kniebeuge', 3, 12, 25),
(32, 'Step Ups', 3, 12, 0),
(33, 'Crunches', 3, 20, 0)